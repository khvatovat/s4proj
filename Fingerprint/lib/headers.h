...
#include <cstdint>
#include <windows.h>
//#include "C:\Program Files (x86)\Windows Kits\10\Include\10.0.22000.0\um\WinBios.h"
//#include <winbio.h>
...
class CFile
{
  ...
  inline uint32 tell() const { return out->tellp(); }
  inline uint32 seek(int32 pos, std::ios_base::seekdir way) const { out->seekp(pos, way); return out->tellp(); }
